/**
 * Budgetura Action Plan & Snapshots
 *
    ...
    $(document).ready(function() {
        ...
        function initActionPlanForm() {
            ...
            $('#regenerate-plan').on('click', function() {
                $('#budgetura-plan-summary, #budgetura-payoff-timeline, #budgetura-payment-schedule, #budgetura-action-items, #budgetura-plan-actions').hide();
        ...
        function generateActionPlan() {
            ...
            Promise.all([
                ...
                $('#plan-loading').hide();
                $('#budgetura-plan-summary, #budgetura-payoff-timeline, #budgetura-payment-schedule, #budgetura-action-items, #budgetura-plan-actions').fadeIn();
        ...
        function displayActionPlan(plan, avalanche, snowball, strategy) {
            ...
            plan.timeline.forEach(function(item, index) {
                ...
                timelineHtml += '<div class="budgetura-timeline-item">';
            ...
            $('#budgetura-timeline-items').html(timelineHtml);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.length === 0) {
                        ...
                        $('#budgetura-snapshot-list, #budgetura-progress-overview, #budgetura-snapshot-comparison').hide();
                    } else {
                        $('#snapshots-empty-state').hide();
                        renderSnapshots(response);
                        populateSnapshotSelects(response);
                        calculateProgress(response);
                        $('#budgetura-snapshot-list, #budgetura-snapshot-comparison').show();
                    }
                },
                error: function() {
        ...
        function renderSnapshots(snapshots) {
            let html = '<div class="budgetura-snapshots-grid">';
            ...
            snapshots.forEach(function(snapshot) {
                ...
                html += '    <div class="budgetura-snapshot-metrics">';
                html += '      <div class="budgetura-metric">';

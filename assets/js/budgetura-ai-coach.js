...
(function($) {
    ...
    function sendMessage(userMessage) {
        ...
        // Send to backend
        $.ajax({
            url: budgetura.restUrl + 'ai-coach',
            method: 'POST',
    ...
    function saveChatHistory() {
        try {
            localStorage.setItem('budgetura_chat_history', JSON.stringify(chatHistory));
        } catch (e) {
    ...
    function loadChatHistory() {
        try {
            const saved = localStorage.getItem('budgetura_chat_history');
            if (saved) {
    ...
    function clearChatHistory() {
        chatHistory = [];
        localStorage.removeItem('budgetura_chat_history');
    ...
    $('#dd-export-chat').on('click', function() {
        ...
        let exportText = 'Budgetura AI Coach Conversation\n';
        exportText += '================================\n\n';
        ...
        a.href = url;
        a.download = 'budgetura-ai-conversation-' + Date.now() + '.txt';

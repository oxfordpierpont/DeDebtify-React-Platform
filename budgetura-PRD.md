# **Budgetura Product Requirements Document (PRD)**

# **Budgetura \- Debt Management WordPress Plugin**
...
Budgetura is a WordPress plugin that transforms a static debt management spreadsheet into an interactive web application. Users can track credit cards, loans, mortgages, bills, and financial goals over multiple years.
...
* Create custom notification triggers in Budgetura  
...
* Budgetura sends data to n8n webhooks  
...
```javascript
/**
 * Budgetura Calculator
 * Frontend calculations for immediate feedback
 */

const BudgeturaCalculator = {
    /**
...
window.BudgeturaCalculator = BudgeturaCalculator;
```
